...
(function (global, factory) {
  ...
  import {arcgisToGeoJSON} from 'xxx/xxx.js' 导入当个方法
...
发送请求的Observable，是一个发生一次就完成的Observable，所以可以用于forkjoin，这里注意forkjoin的用法，是所有的Observable都完成时，才发送结果的Observable
